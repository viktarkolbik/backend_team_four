...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query(value = "SELECT DISTINCT * FROM user_detail as u JOIN user_skill as s ON u.u_id = s.us_u_id WHERE CAST (s.us_name AS VARCHAR) IN :skills AND u.u_deleted = false", nativeQuery = true)
